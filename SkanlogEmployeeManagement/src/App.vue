<template>
  <div>
    ...
    <!-- Add Employee Form -->
    <el-form @submit.prevent="addEmployee" label-width="100px" class="employee-form">
    ...
    <!-- Employee Table -->
    <el-table :data="employees" style="width: 150%; margin: 15px auto" border stripe>
